...
public class orderPage {
    ...
    public void transactionConfirmed(JFrame frame, JPanel panel) {
        ...
        ImageIcon img = new ImageIcon("src/main/java/org/example/Images/confimed.png");
        JLabel confirmedImg = new JLabel(img);
        confirmedImg.setBounds(160, 65, 500, 500);
        ...
        tradeNowLabel.setBounds(88, 8, 116, 27);
